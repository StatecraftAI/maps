...
def merge_acs_with_geometries(acs_df, bg_gdf):
    ...
    try:
        ...
        gdf["percent_no_minors"] = gdf.apply(
            ...
            if row["total_households"] > 0 else 0,
            axis=1
        )
...
def filter_to_pps_district(gdf, config: Config):
    ...
    try:
        ...
        print(f"  ✓ Loaded PPS district boundaries")
    ...
    try:
        ...
        folium.GeoJson(
            ...
            tooltip=folium.GeoJsonTooltip(
                fields=["GEOID", "percent_no_minors", "total_households", "households_no_minors"],
                aliases=["Block Group ID:", "% No Minors:", "Total Households:", "HH without Minors:"],
                localize=True,
                sticky=False,
                labels=True,
                style="""
