...
class Config:
    ...
    DEFAULTS = {
        ...
        'analysis': {
            'registration_diversity_weight': 0.5,
            'turnout_weight': 0.5
        },
        'visualization': {
            'map_dpi': 300,
    ...
    def _setup_paths(self):
        ...
        for directory in [self.data_dir, self.elections_dir, self.geospatial_dir, 
                         self.maps_dir, self.tiles_dir]:
    ...
    def get_input_path(self, filename_key: str) -> pathlib.Path:
        ...
        if filename_key in ['votes_csv', 'voters_csv', 'boundaries_geojson']:
            ...
            # Demographics files go in data directory
    ...
    def print_config_summary(self):
        ...
        print("\n📁 Directories:")
        for key in ['data', 'elections', 'geospatial', 'maps', 'tiles']:
